...
function bindMouseMove(element) {
    ...
    element.addEventListener('mousemove', function(event) {
        ...
        var mouseX = event.clientX,
            ...
            mouseTipPos = element.getAttribute('mousetip-pos');
        // If the element does have a specified mousetip postion...
        if (mouseTipPos !== null) {
            ...
            // ... otherwise, set the default to 'bottom right'
            mouseTip.style.top = mouseY + 15 + 'px';
            mouseTip.style.left = mouseX + 15 + 'px';
        }
    });
}
